...
$c->{request_copy_cc} = ["gareth.knight\@lshtm.ac.uk", "researchdatamanagement\@lshtm.ac.uk", "rory.mcnicholl\@london.ac.uk"];

# The expiry for a document request (in days)
# $c->{expiry_for_doc_request} = 7;

# http://www.google.com/recaptcha
$c->{recaptcha}->{private_key} = "6LcBv8ESAAAAAGN04Kcn-6ojxRyZzsG7RgvgrFMM";
$c->{recaptcha}->{public_key} = "6LcBv8ESAAAAAN5jWl_n9LR5fU5Hy5ptzPPpMxJb";
